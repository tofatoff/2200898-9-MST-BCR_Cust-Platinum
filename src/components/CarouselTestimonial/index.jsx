...
const RATE_STARS = (rate) => {
    ...
    for (let i = 1; i <= rate; i++) {
        stars.push(<BsStarFill color="#F9CC00" />)
    }
    return stars
}
...
const REVIEWS = [
    {
        ...
        photo: imgPhoto,
        message: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi illo mollitia dolore laborum distinctio perspiciatis, iste vel totam? Molestias, ratione?',
        rate: 5
    },
    {
        id: 2,
