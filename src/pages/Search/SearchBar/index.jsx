...
const SearchBar = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(price).length !== 0) {
      ...
      if (!("minPrice" in getPrice)) {
        getPrice.minPrice = "";
      }
      if (!("maxPrice" in getPrice)) {
        getPrice.maxPrice = "";
      }
      console.log(getPrice);
    } else {
    ...
    navigate(
      `/search-result?name=${name}&category=${category}&minPrice=${getPrice.minPrice}&maxPrice=${getPrice.maxPrice}&isRented=${isRented}`
    );
  };
        ...
        >
          ...
          >
            <Row>
              ...
              <Col>
                <FormGroup>
                  <Label for="kategoriMobil">Kategori</Label>
                  <Input
                    disabled={props.disableAllInput}
                    id="kategoriMobil"
                    type="select"
